...
.. code-block:: c
	...
	//参数说明：wegamers官方分配的sdk id，由wegamers提供，必填项
	 params.setSessionkey(String sessionKey);
	//参数说明：wegamers官方提供的sessionkey，由wegamers提供，必填项
...
说明：离开当前页面或者进入后台，在页面onPause触发该方法，暂停服务（避免8.0以上设备对后台服务限制产生不必要的ANR）
...
说明：退出游戏或者销毁当前页面时时调用该接口，用于销毁服务进程
...
.. code-block:: c
	...
	ERR_SESSIONKEY_DEFECT = 6002;//key缺失